// credit to <https://github.com/mshockwave/MIPS-R3000-Assembler/blob/master/gen-src/main/antlr/MipsAsm.g4>
...
op_slt: 'slt' rd=reg ',' rs=reg ',' rt=reg
    ;
op_sltu: 'sltu' rd=reg ',' rs=reg ',' rt=reg
    ;
...
instr_pseudo: op_bgt
    | op_move
    ;
op_bgt: 'bgt' rs=reg ',' rt=reg ',' target=iden
    ;
op_move: 'move' rt=reg ',' rs=reg
    ;  // convert to addi rt, rs, 0
